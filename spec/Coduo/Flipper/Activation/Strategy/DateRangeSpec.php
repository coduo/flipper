...
class DateRangeSpec extends ObjectBehavior
{
     ...
     */
    function it_checks_active_when_its_over(Feature $feature, Context $context)
    {
     ...
     * @before modifyCurrentDate
     */
    function it_checks_active_for_invalid_range(Feature $feature, Context $context)
    {
     ...
     * @before modifyCurrentDate
     */
    function it_checks_active_when_its_hasnt_started_yet(Feature $feature, Context $context)
    {
     ...
     * @before modifyCurrentDate
     */
    function it_can_check_if_feature_has_started_positively(Feature $feature, Context $context)
    {
